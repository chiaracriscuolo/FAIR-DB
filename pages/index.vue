  ...
  <main class="container">
    <section>
      ...
      <p>
        ...
        dependencies, called Approximate Conditional Functional Dependencies (ACFDs), FAIR-DB can identify those attributes in a database that encompass discrimination (e.g.
